...
public final class QueryUtils {
    ...
    private static List<BookListing> extractFeatureFromJson(String bookJSON) {
        ...
        try {
            ...
            JSONArray bookListingsArray = baseJsonResponse.getJSONArray("items");

            // Initialize variables for values to be extracted
            String author;
            int pageCount;

            // For each book in the bookListingsArray, create an {@link BookListing} object
            for (int i = 0; i < bookListingsArray.length(); i++) {
